    ...
    <div style={{ paddingTop: "64px", backgroundColor: "#F7F4EE", minHeight: "100vh" }}>
      <section style={{ padding: "5rem 1.5rem 3rem" }}>
        <div style={{ maxWidth: "960px", margin: "0 auto" }}>
          <p style={{ fontFamily: "'Satoshi', sans-serif", fontSize: "0.9rem", letterSpacing: "0.18em", textTransform: "uppercase", color: "#7A5C3E", marginBottom: "1rem" }}>
            About Nomadica
          </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
            <div style={{ padding: "2rem", backgroundColor: "#1E1E1E", color: "#F7F4EE", borderRadius: "22px" }}>
            ...
            <div style={{ padding: "2rem", backgroundColor: "#fff", borderRadius: "22px", border: "1px solid rgba(30,30,30,0.08)" }}>
              <p style={{ fontFamily: "'Satoshi', sans-serif", fontSize: "0.9rem", marginBottom: "0.75rem", color: "#7A5C3E", textTransform: "uppercase", letterSpacing: "0.18em" }}>
          ...
          <div style={{ marginTop: "3rem", display: "flex", gap: "1rem", flexWrap: "wrap" }}>
            ...
            <Link href="/brand/sustainability" style={{ textDecoration: "none" }}>
              <button style={{ border: "none", background: "#7A5C3E", color: "#F7F4EE", padding: "0.95rem 1.75rem", cursor: "pointer", fontFamily: "'Satoshi', sans-serif", letterSpacing: "0.08em" }}>
