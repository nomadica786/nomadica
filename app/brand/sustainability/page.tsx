      ...
      <section style={{ padding: "4.5rem 1.5rem" }}>
        <div style={{ maxWidth: "1120px", margin: "0 auto" }}>
          <div style={{ display: "grid", gap: "1.5rem", textAlign: "center", marginBottom: "3rem" }}>
            <p style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "0.85rem", letterSpacing: "0.22em", textTransform: "uppercase", color: "#1E1E1E" }}>
              Sustainability
            </p>
            <h1 style={{ fontFamily: "'Playfair Display', sans-serif", fontSize: "clamp(2.5rem, 5vw, 4rem)", margin: 0, color: "#1E1E1E" }}>
              Better choices for every journey.
            </h1>
            <p style={{ margin: "0 auto", maxWidth: "760px", fontFamily: "'Montserrat', sans-serif", fontSize: "1rem", lineHeight: 1.8, color: "rgba(30,30,30,0.72)" }}>
          ...
          <div style={{ display: "grid", gap: "1.5rem", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", marginBottom: "3rem" }}>
            {metrics.map((metric) => (
              <div key={metric.label} style={{ padding: "2rem", backgroundColor: "#fff", borderRadius: "24px", border: "1px solid rgba(30,30,30,0.08)" }}>
                <p style={{ margin: 0, fontFamily: "'Playfair Display', sans-serif", fontSize: "2.5rem", color: "#1E1E1E" }}>{metric.value}</p>
                <p style={{ margin: "0.75rem 0 0", fontFamily: "'Montserrat', sans-serif", fontSize: "0.95rem", fontWeight: 600, color: "#1E1E1E" }}>{metric.label}</p>
                <p style={{ margin: "0.75rem 0 0", fontFamily: "'Montserrat', sans-serif", fontSize: "0.95rem", lineHeight: 1.7, color: "rgba(30,30,30,0.72)" }}>{metric.description}</p>
              </div>
            ))}
          </div>
          ...
          <div style={{ display: "grid", gap: "1.5rem", gridTemplateColumns: "1.4fr 1fr" }}>
            <div style={{ padding: "2.5rem", borderRadius: "28px", backgroundColor: "#1E1E1E", color: "#FFFFFF" }}>
              <h2 style={{ margin: 0, fontFamily: "'Playfair Display', sans-serif", fontSize: "2rem" }}>Responsible materials</h2>
              <p style={{ marginTop: "1.25rem", fontFamily: "'Montserrat', sans-serif", fontSize: "1rem", lineHeight: 1.8, color: "rgba(255, 255, 255,0.88)" }}>
            ...
            <div style={{ padding: "2.5rem", borderRadius: "28px", backgroundColor: "#fff", border: "1px solid rgba(30,30,30,0.08)" }}>
              <h2 style={{ margin: 0, fontFamily: "'Playfair Display', sans-serif", fontSize: "2rem" }}>Continued progress</h2>
              <p style={{ marginTop: "1.25rem", fontFamily: "'Montserrat', sans-serif", fontSize: "1rem", lineHeight: 1.8, color: "rgba(30,30,30,0.72)" }}>
