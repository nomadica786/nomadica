        ...
        >
          <div style={{ fontSize: "0.925rem", color: "rgba(30,30,30,0.65)", lineHeight: 1.8, marginBottom: "2.5rem" }}>
            <p style={{ margin: "0 0 1rem" }}>
              The website <strong>Nomadica.in</strong> is owned and operated by Nomadica. By accessing or using this Platform, you agree to comply with and be bound by the following Terms and Conditions.
            </p>
            <p style={{ margin: 0 }}>
